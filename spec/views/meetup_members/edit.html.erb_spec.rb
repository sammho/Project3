...
describe "meetup_members/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit meetup_member form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => meetup_members_path(@meetup_member), :method => "post" do
